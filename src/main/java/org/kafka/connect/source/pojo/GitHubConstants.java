...
public class GitHubConstants {
    ...
    // Schema names
    public static final String SCHEMA_KEY = "com.kafka.connect.github.IssueKey";
    public static final String SCHEMA_VALUE_ISSUE = "com.kafka.connect.github.IssueValue";
    public static final String SCHEMA_VALUE_USER = "com.kafka.connect.github.UserValue";
    public static final String SCHEMA_VALUE_PR = "com.kafka.connect.github.PrValue";
